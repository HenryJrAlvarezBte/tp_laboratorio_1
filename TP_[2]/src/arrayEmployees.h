 ...
 * \param leng int Recibe el largo del array de empleados
 * \return void
 *
 */
void showMenu(Employee* list, int leng);
 ...
 *
 */
int printEmployees(Employee* list, int leng);
 ...
 *
 */
int initIds(Employee* list, int leng);
 ...
 *
 */
int loadEmployee(Employee* list, int leng);
 ...
 *
 */
int addEmployee(Employee* list, int leng, int id, char name[],char lastName[],float salary,int sector);
 ...
 *
 */
int getIsEmpty(Employee* list, int leng);
 ...
 *
 */
int getIsOccupied(Employee* list, int leng);
 ...
 *
 */
int findEmployeeById(Employee* list, int leng,int id);
 ...
 *
 */
int removeEmployee(Employee* list, int leng, int id);
 ...
 *
 */
int sortEmployees(Employee* list, int leng, int order);
 ...
 *
 */
int modificarEmpleado(Employee* list, int leng);
 ...
 *
 */
float getTotalSalarios(Employee* list, int leng);
 ...
 *
 */
int getMaximoSalario(Employee* list, int leng);
 ...
 *
 */
float getPromedioSalarios(Employee* list, int leng);
 ...
 *
 */
int informarEmpleado(Employee* list, int leng);
 ...
 *
 */
void menuInformesSalarios(Employee* list, int leng);
 ...
 */
int deleteEmployee(Employee* list, int leng);
